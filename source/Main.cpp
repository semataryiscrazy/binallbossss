...
static void AplicarPatchesAOB() {
    ...
    struct { const uint8_t* search; const uint8_t* replace; const char* mask; size_t len; bool* applied; bool* toggle; } tbl[] = {
        // Pixel Estendido
        { (const uint8_t[]){0x90,0xC1,0x00,0x00,0x70,0x41,0x01,0x00,0x00,0x00,0x00,0x00,0xC0,0x3F,0x00,0x00,0x00,0x3F,0x00,0x00,0x80,0x3F},
          (const uint8_t[]){0x90,0xC1,0x00,0x00,0x70,0x41,0x01,0x00,0x00,0x00,0x00,0x00,0xC0,0x00,0x00,0x00,0x00,0x3F,0x00,0x00,0x80,0x3F},
          "xxxxxxxxxxxxxxxxxxxxxx", 22, &PatchPixelEstendidoAplicado, &PatchPixelEstendido },
        // Visao 10X
        { (const uint8_t[]){0xF4,0x04,0x00,0xA0,0xE1,0x0A,0x0A,0x84,0xED,0x0E,0x2A,0x84,0xED,0x05,0x1A,0x84,0xED,0x00,0x3A,0x84,0xED,0xF0,0x81,0xBD,0xE8,0x00,0x00,0xB4,0x43,0xDB,0x0F,0x49,0x40,0x10,0x2A,0x00,0xEE,0x00,0x10,0x80,0xE5,0x10,0x3A,0x01,0xEE,0x14,0x10,0x80,0xE5,0x00,0x2A,0x30,0xEE,0x00,0x10,0x00,0xE3,0x41,0x3A,0x30,0xEE,0x80,0x1F},
          (const uint8_t[]){0xF4,0x04,0x00,0xA0,0xE1,0x0A,0x0A,0x84,0xED,0x0E,0x2A,0x84,0xED,0x05,0x1A,0x84,0xED,0x00,0x3A,0x84,0xED,0xF0,0x81,0xBD,0xE8,0x00,0x00,0xB4,0x43,0xDB,0x0F,0x90,0x40,0x10,0x2A,0x00,0xEE,0x00,0x10,0x80,0xE5,0x10,0x3A,0x01,0xEE,0x14,0x10,0x80,0xE5,0x00,0x2A,0x30,0xEE,0x00,0x10,0x00,0xE3,0x41,0x3A,0x30,0xEE,0x80,0x1F},
          "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", 68, &PatchVisao10XAplicado, &PatchVisao10X },
        // No Recoil
        { (const uint8_t[]){0x7A,0x44,0xF0,0x48,0x2D,0xE9,0x10,0xB0,0x8D,0xE2,0x02,0x8B,0x2D,0xED,0x08,0xD0},
          (const uint8_t[]){0x7A,0xFF,0xF0,0x48,0x2D,0xE9,0x10,0xB0,0x8D,0xE2,0x02,0x8B,0x2D,0xED,0x08,0xD0},
          "xxxxxxxxxxxxxxxx", 16, &PatchNoRecoilAOBAplicado, &PatchNoRecoilAOB },
        // FOV 360
        { (const uint8_t[]){0x70,0x42,0x00,0x00,0x00,0x00,0x00,0x00,0xC0,0x3F,0x0A,0xD7,0xA3,0x3B,0x0A,0xD7,0xA3,0x3B,0x8F,0xC2,0x75,0x3D,0xAE,0x47,0xE1,0x3D,0x9A,0x99,0x19,0x3E,0xCD,0xCC,0x4C,0x3E,0xA4,0x70,0xFD,0x3E},
          (const uint8_t[]){0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0xC0,0x3F,0x0A,0xD7,0xA3,0x3B,0x0A,0xD7,0xA3,0x3B,0x8F,0xC2,0x75,0x3D,0xAE,0x47,0xE1,0x3D,0x9A,0x99,0x19,0x3E,0xCD,0xCC,0x4C,0x3E,0xA4,0x70,0xFD,0x3E},
          "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", 38, &PatchFOV360Aplicado, &PatchFOV360 },
        // Bala Infinita
        { (const uint8_t[]){0xD8,0x00,0xD0,0xE5,0x1E,0xFF,0x2F,0xE1},
          (const uint8_t[]){0xFC,0x26,0x00,0x00,0x1E,0xFF,0x2F,0xE1},
          "xxxxxxxx", 8, &PatchBalaInfinitaAplicado, &PatchBalaInfinita },
        // Wall Hack
        { (const uint8_t[]){0x3F,0xAE,0x47,0x81,0x3F,0xAE,0x47,0x81,0x3F,0xAE,0x47,0x81,0x3F,0x00,0x1A,0xB7,0xEE,0xDC,0x3A,0x9F,0xED,0x30,0x00,0x4F,0xE2,0x43,0x2A,0xB0,0xEE,0xEF,0x0A,0x60,0xF4,0x43,0x6A,0xF0,0xEE,0x1C,0x00,0x8A,0xE2,0x43,0x5A,0xF0,0xEE,0x8F,0x0A,0x48,0xF4,0x43,0x2A,0xF0,0xEE,0x43,0x7A,0xB0,0xEE,0x8F,0x0A,0x40,0xF4,0x41,0xAA,0xB0,0xEE,0xFE,0x05,0xA0,0xE3,0x41,0x1A,0xF0,0xEE,0x2C,0x00,0x8A,0xE5,0x10},
          (const uint8_t[]){0x3F,0xAE,0x47,0x81,0x3F,0xAE,0x47,0x81,0xBF,0xAE,0x47,0x81,0x3F,0x00,0x1A,0xB7,0xEE,0xDC,0x3A,0x9F,0xED,0x30,0x00,0x4F,0xE2,0x43,0x2A,0xB0,0xEE,0xEF,0x0A,0x60,0xF4,0x43,0x6A,0xF0,0xEE,0x1C,0x00,0x8A,0xE2,0x43,0x5A,0xF0,0xEE,0x8F,0x0A,0x48,0xF4,0x43,0x2A,0xF0,0xEE,0x43,0x7A,0xB0,0xEE,0x8F,0x0A,0x40,0xF4,0x41,0xAA,0xB0,0xEE,0xFE,0x05,0xAE,0xE3,0x41,0x1A,0xF0,0xEE,0x2C,0x00,0x8A,0xE5,0x10},
          "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", 78, &PatchWallHackAplicado, &PatchWallHack },
        // Speed Hack
        { (const uint8_t[]){0x02,0x2B,0x07,0x3D,0x02,0x2B,0x07,0x3D,0x02,0x2B,0x07,0x3D,0x00,0x00,0x00,0x00,0x9B,0x6C,0xF2,0x41,0x00,0x00,0x00,0x00},
          (const uint8_t[]){0xE3,0xA5,0x9B,0x3C,0xE3,0xA5,0x9B,0x3C,0x02,0x2B,0x07,0x3D,0x00,0x00,0x00,0x00,0x9B,0x6C,0xF2,0x41,0x00,0x00,0x00,0x00},
          "xxxxxxxxxxxxxxxxxxxxxxxx", 24, &PatchSpeedHackAplicado, &PatchSpeedHack },
        // Camera Left
        { (const uint8_t[]){0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x3F,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0xBF,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0xBF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x3F,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
          (const uint8_t[]){0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x40,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0xBF,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0xBF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x3F,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0xBF},
          "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", 48, &PatchCameraLeftAplicado, &PatchCameraLeft },
        // 2X Tracking
        { (const uint8_t[]){0xC0,0x3F,0x33,0x33,0x93,0x3F,0x8F,0xC2,0xF5,0x3C,0xCD,0xCC,0xCC,0x3D,0x02,0x00,0x00,0x00,0xEC,0x51,0xB8,0x3D,0xCD,0xCC,0x4C,0x3F,0x00,0x00,0x00,0x00,0x00,0x00,0xA0,0x42,0x00,0x00,0xC0,0x3F,0x33,0x33,0x13,0x40,0x00,0x00,0xF0,0x3F,0x00,0x00,0x80,0x3F,0x01},
          (const uint8_t[]){0xC0,0x3F,0x33,0x33,0x93,0x3F,0x8F,0xC2,0xF5,0x3C,0xCD,0xCC,0xCC,0x3D,0x00,0x00,0x00,0x00,0xEC,0x51,0xB8,0x3D,0xCD,0xCC,0x4C,0x3F,0x00,0x00,0x00,0x00,0x00,0x00,0xA0,0x42,0x00,0x00,0xC0,0x3F,0x33,0x33,0x13,0x40,0x00,0x00,0xF0,0x3F,0x00,0x00,0x80,0x5C,0x01},
          "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", 51, &PatchTracking2XAplicado, &PatchTracking2X },
    };
